...
def pv(path, leading_pt_cut, subleading_pt_cut, leading_eta_cut, eta_cut_key):
    ...
    for dau in range(32):
        ...
        ntrue_dau_gen_leading=dau_pt_gen_leading[dau]==-1
        ...
        ntrue_dau_gen_subleading=dau_pt_gen_subleading[dau]==-1
