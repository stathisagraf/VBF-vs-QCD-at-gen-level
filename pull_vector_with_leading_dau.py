...
def pv_only_leading(path, leading_pt_cut, subleading_pt_cut, leading_eta_cut, eta_cut_key, dau_pt_cuts = 0):
    ...
    dau_pt_gen_leading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_pt'].array()[nonzero_gen][comb_gen_mask*leading_gen])))
    dau_eta_gen_leading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_eta'].array()[nonzero_gen][comb_gen_mask*leading_gen])))
    dau_phi_gen_leading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_phi'].array()[nonzero_gen][comb_gen_mask*leading_gen])))
    dau_mass_gen_leading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_mass'].array()[nonzero_gen][comb_gen_mask*leading_gen])))
    
    dau_pt_gen_subleading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_pt'].array()[nonzero_gen][comb_gen_mask*subleading_gen])))
    dau_eta_gen_subleading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_eta'].array()[nonzero_gen][comb_gen_mask*subleading_gen])))
    dau_phi_gen_subleading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_phi'].array()[nonzero_gen][comb_gen_mask*subleading_gen])))
    dau_mass_gen_subleading=(ak.to_numpy(ak.flatten(data['Events']['GenJets_dau0_mass'].array()[nonzero_gen][comb_gen_mask*subleading_gen])))
    ...
    y_dau_gen_leading = y(dau_pt_gen_leading, dau_eta_gen_leading, dau_mass_gen_leading)
    y_dau_gen_subleading = y(dau_pt_gen_subleading, dau_eta_gen_subleading, dau_mass_gen_subleading)
    
    
    delta_y_leading = y_dau_gen_leading-y_jet_gen_leading
    delta_phi_leading = np.arcsin(np.sin(dau_phi_gen_leading-jet_phi_gen_leading))
    
    
    delta_y_subleading = y_dau_gen_subleading-y_jet_gen_subleading
    delta_phi_subleading = np.arcsin(np.sin(dau_phi_gen_subleading-jet_phi_gen_subleading))
    ...
    pull_vector_y_leading = dau_pt_gen_leading/jet_pt_gen_leading*abs_r_leading*delta_y_leading
    pull_vector_phi_leading = dau_pt_gen_leading/jet_pt_gen_leading*abs_r_leading*delta_phi_leading
