...
def rel_pv_dau_mass(path, leading_pt_cut, subleading_pt_cut, leading_eta_cut, eta_cut_key, dau_pt_cuts = 0, dau_mass_cuts = 0):
    ...
    j_leading=vector.array({
                        "x" : y_jet_gen_leading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask],
                        "y": jet_phi_gen_leading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask]                
                        })
    
    j_subleading=vector.array({
                        "x" : y_jet_gen_subleading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask],
                        "y": jet_phi_gen_subleading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask]   
                        })
    
    pull_vector_leading = vector.array({
                        "x" : pull_vector_y_leading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask],
                        "y": pull_vector_phi_leading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask]
                        })
    
    pull_vector_subleading = vector.array({
                        "x" : pull_vector_y_subleading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask],
                        "y": pull_vector_phi_subleading[leading_dau_mask*leading_mass_mask*subleading_dau_mask*subleading_mass_mask]
                        })
    ...
    return leading_relative_pa,subleading_relative_pa, x

vbf_path = 'perfNano_VBFHInv_PU200.l1ctlayer1.root'
qcd_path = 'perfNano_QCD_PU200.l1ctlayer1.root'


leading_relative_pa,subleading_relative_pa, x = rel_pv_dau_mass(vbf_path,20,0,0,0, dau_mass_cuts = 0.5)
