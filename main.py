...
from pull_vector_with_leading_dau import pv_only_leading
...
# dau_mass_cut_table = [0,0.1,0.11,0.5]
# dau_pt_cuts = [0,1,4,10,15]
# leading_jet_pt_cuts = [0,20,50,70]
# for pt_cut_leading in leading_jet_pt_cuts:
#     for dau_pt_cut in dau_pt_cuts:
#         for dau_cuts_mass in dau_mass_cut_table:
                
#             vbf_pv_y_leading, vbf_pv_phi_leading, vbf_pv_y_subleading, vbf_pv_phi_subleading, x = pv_dau_mass(vbf_path,pt_cut_leading,0,1.4,1,dau_pt_cuts = dau_pt_cut,  dau_mass_cuts = dau_cuts_mass)
            
#             qcd_pv_y_leading, qcd_pv_phi_leading, qcd_pv_y_subleading, qcd_pv_phi_subleading, z = pv_dau_mass(qcd_path,pt_cut_leading,0,1.4,1,dau_pt_cuts = dau_pt_cut,  dau_mass_cuts = dau_cuts_mass)
...
#             plt.text(-1.8,0.085,r'Daughter $mass$ > {} GeV'.format(dau_cuts_mass))
#             plt.text(-1.8,0.07,r'Daughter $p_T$ > {} GeV'.format(dau_pt_cut))
#             plt.text(-1.8,0.055,r'|$\eta$|>1.4')
#             plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Leading_Pull_angle_pt_cut_{}_mass_cut_{}_dau_cuts_{}_forward.pdf'.format(dau_pt_cut,pt_cut_leading,dau_cuts_mass))
#             plt.show()
...
#             plt.text(-1.8,0.07,r'Daughter $p_T$ > {} GeV'.format(dau_pt_cut))
#             plt.text(-1.8,0.055,r'|$\eta$|>1.4')
#             plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Subeading_Pull_angle_pt_cut_{}_mass_cut_{}_dau_cuts_{}_forward.pdf'.format(dau_pt_cut,pt_cut_leading,dau_cuts_mass))
...
#             vbf_rel_pa_leading, vbf_rel_pa_subleading, x = rel_pv_dau_mass(vbf_path,pt_cut_leading,0,1.4,1,dau_pt_cuts = dau_pt_cut,  dau_mass_cuts = dau_cuts_mass)
            
#             qcd_rel_pa_leading, qcd_rel_pa_subleading, z = rel_pv_dau_mass(qcd_path,pt_cut_leading,0,1.4,1,dau_pt_cuts = dau_pt_cut,  dau_mass_cuts = dau_cuts_mass)
...
#             plt.text(-1.8,0.07,r'Daughter $p_T$ > {} GeV'.format(dau_pt_cut))
#             plt.text(-1.8,0.055,r'|$\eta$|>1.4')
#             plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Leading_Rel_pull_angle_pt_cut_{}_mass_cut_{}_dau_cuts_{}_forward.pdf'.format(dau_pt_cut,pt_cut_leading,dau_cuts_mass))
#             plt.show()
...
#             plt.text(-1.8,0.07,r'Daughter $p_T$ > {} GeV'.format(dau_pt_cut))
#             plt.text(-1.8,0.055,r'|$\eta$|>1.4')
#             plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Subeading_Rel_pull_angle_pt_cut_{}_mass_cut_{}_dau_cuts_{}_forward.pdf'.format(dau_pt_cut,pt_cut_leading,dau_cuts_mass))
...
for pt_cut_leading in leading_jet_pt_cuts:
    ...
    for dau_cuts_pt in dau_pt_cut_table:
        ...
        vbf_pv_y_leading, vbf_pv_phi_leading, vbf_pv_y_subleading, vbf_pv_phi_subleading, x = pv_only_leading(vbf_path,pt_cut_leading,0,1.4,1, dau_pt_cuts = dau_cuts_pt)
        
        qcd_pv_y_leading, qcd_pv_phi_leading, qcd_pv_y_subleading, qcd_pv_phi_subleading, z = pv_only_leading(qcd_path,pt_cut_leading,0,1.4,1, dau_pt_cuts = dau_cuts_pt)
        ...
        plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Leading_Pull_angle_pt_cut_{}_dau_cuts_{}_leading_dau_forward.pdf'.format(pt_cut_leading,dau_cuts_pt))
        plt.show()
        ...
        plt.text(-1.8,0.08,r'Only leading daughter')
        plt.text(-1.8,0.065,r'|$\eta$|>1.4')
        plt.savefig('/home/stathis/Desktop/Research project/Data/VBF vs QCD at gen/Plots/Subeading_Pull_angle_pt_cut_{}_dau_cuts_{}_leading_dau_forward.pdf'.format(pt_cut_leading,dau_cuts_pt))
